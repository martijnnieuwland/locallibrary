...
class RenewBookInstancesViewTest(TestCase):
    def setUp(self):
        ...
        # Give testuser2 permission to renew books.
    ...
    def test_form_invalid_renewal_date_past(self):
        ...
        self.assertFormError(response.context['form'],
                             'due_back', 'Invalid date - renewal in past')
    ...
    def test_form_invalid_renewal_date_future(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertFormError(response.context['form'],
                             'due_back', 'Invalid date - renewal more than 4 weeks ahead')
...
class AuthorCreateViewTest(TestCase):
    ...
    def setUp(self):
        # Create a user
        test_user_permission = User.objects.create_user(username='testuser_p',
                                                        password='1X<ISRUkw+tuK')
        test_user_no_permission = User.objects.create_user(username='testuser_n',
        ...
        test_user_permission.user_permissions.add(permAddAuthor)
        test_user_permission.save()


    def test_logged_in_with_permission_ok(self):
        login = self.client.login(username='testuser_p', password='1X<ISRUkw+tuK')
    ...
    def test_logged_in_without_permission_forbidden(self):
        login = self.client.login(username='testuser_n', password='2HJ1vRV0Z&3iD')
        response = self.client.get(reverse('author-create'))
    ...
    def test_redirect(self):
        ...
        author = Author.objects.get(first_name='John', last_name='Doe', date_of_birth='1950-01-01')
